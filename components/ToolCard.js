...
export default function ToolCard({slug, title, description}){
  ...
  return (
    <Link href={getLocalizedHref(`/tools/${slug}`, locale)} className="card block transform transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-emerald-200">
