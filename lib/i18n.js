...
const localizedToolText = {
  ja: {
    ...
    'vat-calculator': {title: '税金計算機', description: '任意の税率で税額と税込合計を計算します。'},
    'tax33-calculator': {title: '源泉徴収税計算機', description: '任意の税率を入力して、控除前後の金額を計算します。'},
    ...
    'construction-dictionary': {title: '韓国語の建設現場用語辞典', description: '韓国語の現場用語と標準的な意味を検索します。'},
  ...
  zh: {
    ...
    'vat-calculator': {title: '税费计算器', description: '输入自定义税率，计算税额和含税总额。'},
    'tax33-calculator': {title: '预扣税计算器', description: '输入自定义税率，计算税前和税后金额。'},
    ...
    'construction-dictionary': {title: '韩语施工现场术语词典', description: '搜索韩语现场术语及其标准含义。'},
  ...
  es: {
    ...
    'vat-calculator': {title: 'Calculadora de impuestos', description: 'Calcula impuesto y total con una tasa personalizable.'},
    'tax33-calculator': {title: 'Calculadora de retención fiscal', description: 'Calcula importes antes y después de impuestos con una tasa personalizable.'},
    ...
    'construction-dictionary': {title: 'Diccionario coreano de obra', description: 'Busca términos coreanos de construcción y su significado estándar.'},
  ...
  fr: {
    ...
    'vat-calculator': {title: 'Calculateur de taxe', description: 'Calculez taxe et total avec un taux personnalisable.'},
    'tax33-calculator': {title: 'Calculateur de retenue fiscale', description: 'Calculez les montants avant et après impôt avec un taux personnalisable.'},
    ...
    'construction-dictionary': {title: 'Dictionnaire coréen de chantier', description: 'Recherchez des termes coréens de chantier et leur sens standard.'},
